    ...
    return (
        <div className="flex h-screen w-full overflow-hidden bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-display">
            ...
            <main className="flex-1 flex flex-col h-full overflow-hidden relative">
                <div className="flex-1 overflow-y-auto p-6 md:p-10 lg:px-16 flex flex-col gap-10 scroll-smooth">
                    {/* Hero & Search Section */}
                    ...
                    {/* Chips / Quick Filters */}
                    <section className="flex gap-3 overflow-x-auto pb-4 pt-2 scrollbar-hide -mx-6 px-6 md:mx-0 md:px-0 mb-32">
